...
(function () {
  ...
  function categoryCollapse() {
    ...
    collapse.on('hide.bs.collapse', function () {
      ...
      if (parentId) {
        $("#".concat(parentId, " .bi.bi-folder2-open")).attr('class', 'bi bi-folder');
        $("#".concat(parentId, " i.bi")).addClass('rotate');
    ...
    collapse.on('show.bs.collapse', function () {
      ...
      if (parentId) {
        $("#".concat(parentId, " .bi.bi-folder")).attr('class', 'bi bi-folder2-open');
        $("#".concat(parentId, " i.bi")).removeClass('rotate');
